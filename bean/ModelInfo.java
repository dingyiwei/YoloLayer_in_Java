...
public class ModelInfo implements Serializable {
    ...
    public ModelInfo(String modelSaveDir, String modelName, int outputSize) {
        this.modelSaveDir = modelSaveDir;
        framework = "caffe";
        offlineModelVersion = "100.150.032.001";
        offlineModel = modelName + ".cambricon";
        offlineModelName = modelName;
        onlineModel = modelName + ".prototxt";
        onlineModelPara = modelName + ".caffemodel";
        input_Number = 1;
        input_N = 1;
        input_C = 3;
        input_H = 416;
